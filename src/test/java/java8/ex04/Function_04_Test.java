...
public class Function_04_Test {
    ...
    // TODO AGE >=18
    Predicate<Person> adult = (Person p) -> {
        return p.getAge() >= 18;
    };
    // end::filterMethod[]
    ...
    Predicate<Person> lastnameIsFrance = (Person p) -> {
        return p.getLastname().equals("France");
    };
    // end::adult[]
    // TODO compléter la fonction
    // TODO le prédicat vérifie que le prénom est "Armor"
    Predicate<Person> firstnameIsArmor = (Person p) -> {
        return p.getFirstname().equals("Armor");
    };
